...
<html lang="pt">
  <head>
    ...
    />
    <title>Loja Kingdom Multimarcas</title>
...
<div class="brn-large black right"><a href=""  onclick="window.print()">Imprimir</a>
</div>
...
<div class="section no-pad-bot" id="index-banner">
      <div class="container">
        ...
        <img src="../assets/imagens/Kingdom Multimarcas (4).png"
              width="300px" />
          <div class="col s12">
